...
class PlayerBuildMenu(MGUI.WidgetCollection):
    def __init__(self, x, y, width, height, base_buildings, player_data, place_building_method):
        ...
        for i, bname in enumerate(player_data.owned_buildings):
            ...
            self.add_widget(tmp_name_label, "button_" + bname + "_namelabel", layer=5)
            ...
            self.add_widget(tmp_cost_label, "button_" + bname + "_costlabel", layer=5)
            ...
            self.add_widget(tmp_cost_img, "button_" + bname + "_costimg", layer=5)
            ...
            self.add_widget(tmp_place_button, "button_" + bname + "_place", layer=5)
