...
class CanvasMaterials(MSGUI.GUICanvas):
    def __init__(self, x, y, width, height):
        ...
        # Player name
        self.plname_label = MSGUI.Label(8, 8, self.get_width() - 16, 24, font_18)
        ...
        # Crystal image
        self.crystal_button = MSGUI.ImageWidget(8, 40, 64, 64, "assets/materials/carbcrystal.png")
